								...
								.map((row, index) => {
									...
									return (
										...
										>
											...
											<TableCell align='center'> {row.connectionType}</TableCell>
											<TableCell align='center'>
												<div className='sub-categories'>
													<span class='status d-inline-flex align-items-center' style={{ backgroundColor: row.bgColor, color: row.color }}>
														{row.statusIcon}
														{row.stats}
													</span>
												</div>
