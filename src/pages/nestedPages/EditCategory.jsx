							...
							<form onSubmit={handleSubmit}>
								<div className='form-body'>
									...
									<div className='row mb-5'>
										...
										<div className='col-7'>
											<input type='text' id='category-number' placeholder='أدخل رقم التصنيف' value={category.idNumbers} />
										</div>
									</div>
									<div className='row mb-5'>
										<div className='col-3'>
										...
										<div className='col-7'>
											<input type='text' id='category-name' placeholder='أدخل أسم التصنيف' value={category.productName} />
										</div>
									</div>
									<div className='row mb-5'>
										<div className='col-3'>
